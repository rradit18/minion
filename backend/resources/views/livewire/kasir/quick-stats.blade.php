<div wire:poll.30000ms class="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-5 flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $transactionCount }}</p>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-5 flex items-center gap-4">
        ...
        <div>
            <p class="text-sm text-gray-500 dark:text-gray-400">Barber On-Shift</p>
            <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $onShiftCount }}</p>
        </div>
    </div>
</div>
