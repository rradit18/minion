      ...
      <div className="bg-[#1a1a1a] text-white px-6 py-4">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          ...
          <button onClick={() => { clearSession(); router.push("/"); }}
            className="flex items-center gap-2 text-xs font-semibold px-3 py-2 rounded-xl bg-white/5 text-gray-300 hover:bg-red-500/20 hover:text-red-300 transition-colors border border-white/10 hover:border-red-500/30">
